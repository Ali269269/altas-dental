...
// ─── Mobile Accordion Cards — same horizontal expand animation as desktop ─────
function MobileAccordionCards() {
  const [active, setActive] = useState(0);
  const [isVisible, setIsVisible] = useState(false);
  const containerRef = useRef<HTMLDivElement>(null);

  // Same auto-cycle as desktop (5 s interval)
  useEffect(() => {
    if (!isVisible) return;
  ...
  // Same intersection-observer entrance trigger as desktop
  useEffect(() => {
  ...
  return (
    <div ref={containerRef}>
      {/* Horizontal flex accordion — identical expand mechanic to desktop */}
      <div style={{
        display: "flex",
        gap: 8,
        height: 340,
          ...
          return (
            <div
              ...
              style={{
                ...
                minWidth: 0,
                // Same slide-in entrance animation
            ...
            >
              ...
              {/* Dark gradient overlay — same transition as desktop */}
              <div style={{
                position: "absolute", inset: 0,
                background: isActive
              ...
              {/* Expanded: slide-up content — same timing as desktop */}
              <div style={{
                ...
                <div style={{
                  display: "inline-block", background: "#43121e",
                  borderRadius: 50, padding: "4px 12px", marginBottom: 8,
                }}>
                  <span style={{
                    color: "#F0F0F0", fontSize: 10, fontWeight: 600, textTransform: "uppercase",
                  }}>
                    {card.label}
                  </span>
                </div>
      ...
      <div style={{ display: "flex", justifyContent: "center", gap: 6, marginTop: 18 }}>
        {CARDS.map((_, i) => (
          <button
            ...
            onClick={() => setActive(i)}
            style={{
              width: i === active ? 24 : 7, height: 6, borderRadius: 3,
...
// ─── Desktop Accordion Cards (horizontal expand) ──────────────────────────────
          ...
          >
            ...
            <div style={{
              ...
              <div style={{
                ...
                <span style={{ color: "#F0F0F0", fontSize: 13, fontWeight: 600, textTransform: "uppercase" }}>
                  {card.label}
                </span>
              </div>
              <p style={{
                color: "#fff", fontSize: 17, lineHeight: 1.6, fontWeight: 300,
                margin: 0, maxWidth: "80%", textShadow: "0 2px 4px rgba(0,0,0,0.5)",
              }}>
                {card.desc}
              </p>
            </div>
...
function BulletItem({ title, text }: { title: string; text: string }) {
  return (
    <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
      <span style={{ color: "#4F1422", fontSize: 16, fontWeight: 700, flexShrink: 0, marginTop: 1 }}>›</span>
      <p style={{ fontSize: 14, lineHeight: 1.35, color: "#5D5153", fontWeight: 300, margin: 0 }}>
        <strong style={{ fontWeight: 540, fontSize: "19px", color: "#4F1422", fontFamily: "var(--font-seasons)" }}>
          {title}
        </strong>
        {" "}{text}
      </p>
...
export default function DentisterieEsthetiquePage() {
  ...
  return (
    <>
      <style>{`
        /* ════════════════════════════════════════════
           MOBILE STYLES — only fires at ≤768px
  ...
  display: none !important;
          ...
          .de-why-image {
            ...
            /* Restore the drop shadow that the pill border-radius clips on mobile */
        ...
        @media (max-width: 400px) {
          ...
          .de-why-image { height: 180px !important; }
        }
      `}</style>
      ...
      <main style={{ background: "#FFFFFF" }}>
        ...
        >
          <img
            ...
            style={{
              ...
              objectPosition: "center 44%", transform: "scaleX(-1)",
            }}
          />
          <div style={{
            width: "100%", height: "100%",
          ...
          <div className="de-hero-title" style={{ position: "absolute", bottom: 132, left: 48 }}>
            <h1 style={{ fontSize: 28, fontWeight: 500, color: "#FFFFFF", lineHeight: 1.2 }}>
              <span style={{ fontWeight: 600 }}>Dentisterie Esthétique</span> <br/>
              <span style={{ fontWeight: 500, fontSize: 16, color: "#FFFFFF", display: "inline-block" }}>
        ...
        <section
          className="de-intro"
          style={{ background: "#711C31", padding: "56px 160px", textAlign: "center" }}
        >
          <p style={{
            fontSize: 16, lineHeight: 1.6, color: "#FFFFFF", fontWeight: 300,
          ...
          <div className="de-intro-shadow" style={{
  position: "absolute",
  bottom: 9,
  left: 0,
  right: 0,
  height: "170px",
  background: "linear-gradient(to top, rgba(36, 5, 15, 0.95) 0%, rgba(36, 5, 15, 0.55) 35%, transparent 100%)",
  pointerEvents: "none",
  zIndex: 1,
}} />
        </section>
        ...
        >
          {/* Left image — shadow added via className on mobile */}
          <div
          ...
          {/* Right content */}
          <div className="de-why-content" style={{ flex: 1, paddingTop: 8, paddingRight: 60 }}>
            <h2 style={{
              fontSize: 26, fontWeight: 600, color: "#711C31",
              marginBottom: 18, lineHeight: 1.25, letterSpacing: "0.1px",
            }}>
              Choisissez Atlas Dental Center pour la
              <br />dentisterie esthétique
            </h2>
            <p style={{
              fontSize: 16.5, lineHeight: 1.4, color: "#5D5153",
              fontWeight: 500, marginBottom: 28, paddingRight: 50,
            }}>
        ...
        >
          <h2 style={{
            fontSize: 28, fontWeight: 600, color: "#711C31",
            textAlign: "center", marginBottom: 40, letterSpacing: "0.5px",
          }}>
            Dentisterie Esthétique
          </h2>

          {/* Mobile gets same horizontal expand animation, desktop gets original */}
          {isMobile ? <MobileAccordionCards /> : <AccordionCards />}
        </section>
        ...
        >
          <a
            ...
            style={{
              display: "inline-block", background: "#43121e", color: "#FFFFFF",
              padding: "14px 36px", borderRadius: 50, fontSize: 14,
              fontWeight: 500, textDecoration: "none", letterSpacing: "0.3px",
            }}
          >
            Prendre rendez-vous
          </a>
