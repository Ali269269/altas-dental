...
export default function ClinicalNotesPage() {
  ...
  const inputBorder = isDark ? "#5C2A3A" : "#753141";
  ...
  const sectionLabel = "text-[13px] font-bold numeric-font flex items-center gap-2 mb-3";
  ...
  return (
    <>
      {/* ── Responsive styles injected via a style tag — no global CSS needed ── */}
      <style>{`
        .cn-page { margin-left: 40px; margin-top: 40px; }
        .cn-header { display: flex; align-items: flex-start; justify-content: space-between; margin-bottom: 24px; }
        .cn-header-btns { display: flex; gap: 12px; }
        .cn-main-grid { display: grid; grid-template-columns: 1fr 320px; gap: 20px; }
        @media (max-width: 768px) {
          .cn-page { margin-left: 0 !important; margin-top: 16px !important; padding: 0 4px !important; }
          .cn-header { flex-direction: column; align-items: flex-start; gap: 12px; }
          .cn-header-btns { width: 100%; }
          .cn-header-btns button { flex: 1; font-size: 12px !important; padding: 8px 10px !important; }
          .cn-main-grid { grid-template-columns: 1fr !important; }
        }
      `}</style>

      <div className="cn-page min-h-full transition-colors duration-300">
        ...
        <div className="cn-header">
          <div>
            ...
            <p className="text-sm mt-1" style={{ color: isDark ? "#ffffff" : "#591727" }}>{subtitle}</p>
          </div>
          <div className="cn-header-btns">
            <button
              ...
              className={`px-5 py-2 rounded-xl text-sm font-semibold border transition-colors ${
                isDark
                  ? "border-[#591727] text-[#591727] hover:bg-[#5C2A3A]"
                  : "border-[#591727] text-[#591727] hover:bg-[#EDE0C4]"
              }`}
              style={{ backgroundColor: isDark ? "#ffffff" : "#ffffff" }}
            >
              Discard Changes
            </button>
            <button
        ...
        <div className="cn-main-grid">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className={`rounded-2xl p-5 border ${cardBorder}`} style={{ backgroundColor: card }}>
              <p className={sectionLabel} style={{ color: "#711C31" }}>
                <span className="text-[#711C31]">
              ...
              <div className="flex flex-wrap gap-2 items-center">
                {diagTags.map(tag => (
                  <div
                    ...
                    style={{ borderColor: isDark ? "#C9922A" : "#ffbcbc", color: "#FFFFFF", backgroundColor: "#681A2D" }}
                  >
                    {tag.label}
                    <button
                ...
                {newTagInput ? (
                  ...
                  <button
                    ...
                    className="px-3 numeric-font py-1 rounded-full text-[11px] font-semibold border transition-colors hover:opacity-80"
            ...
            <div className={`rounded-2xl p-5 border ${cardBorder}`} style={{ backgroundColor: card }}>
              ...
              <div className="flex flex-col gap-2 mb-3">
                {procedures.map((step) => (
                  <div
                    key={step.id}
                    className={`flex items-center gap-2 px-3 py-3 rounded-xl border ${cardBorder}`}
                    style={{ backgroundColor: "#D1CDCE80" }}
                  >
                    ...
                    <button
                      ...
                      className="w-8 h-8 flex items-center justify-center rounded-lg transition-colors hover:bg-red-100 shrink-0"
                      style={{ color: text2 }}
                    >
          ...
          <div className="flex flex-col gap-4">
            ...
            {/* DIAGNOSTICS & IMAGING */}
            <div className={`rounded-2xl p-5 border ${cardBorder}`} style={{ backgroundColor: card }}>
              <p className={sectionLabel} style={{ color: "#591727" }}>
                <span className="text-[#591727]">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
