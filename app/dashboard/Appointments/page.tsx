...
function PendingModal({ isDark,card,cardBorder,text1,text2,pageBg,cardInner,onClose }:PendingModalProps){
  ...
  <button
    onClick={onClose}
    className="w-9 h-9 flex items-center justify-center rounded-lg border transition hover:scale-105"
    style={{
      borderColor: isDark ? "#5C2A3A" : "#D9C9A8",
      backgroundColor: isDark ? "#4A2030" : "#FDFAF4",
      color: isDark ? "#F5ECD7" : "#3D0A1F",
    }}
  >
    <svg
      width="18"
  ...
  <h2
    ...
    style={{ color: isDark ? "#ffffff" : "#711C31" }}
  >
    APPOINTMENTS /
  </h2>
        ...
        <div className={`rounded-2xl p-8 border ${cardBorder}`} style={{backgroundColor:card}}>
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="flex flex-col gap-5">
              <div>
                <label
  className="flex items-center gap-2 text-[11px] font-semibold tracking-wider uppercase mb-2"
  style={{ color: isDark ? "#591727" : "#7A6040" }}
>
  <span style={{ color: "#591727" }}>📅</span>
  SELECT DATE
</label>
    ...
    backgroundColor:
      displayMode === "calendar"
        ? isDark
          ...
          : "#3D0A1F"
        : card,
    color: displayMode === "calendar" ? "#F5ECD7" : text2,
  }}
>
  <svg
    width="16"
    ...
    backgroundColor:
      displayMode === "list"
        ? isDark
          ...
          : "#3D0A1F"
        : card,
    color: displayMode === "list" ? "#F5ECD7" : text2,
  }}
>
  <svg
    width="16"
            ...
            <tbody>
              {allAppointments.map((row,i)=>(
                <tr key={i} className="transition-colors cursor-pointer"
                  ...
                  <td className="px-4 py-3"><span className="text-[13px]" style={{color:text2}}>{row.specialty}</span></td>
                  <td className="px-4 py-3"><span className="text-[13px]" style={{color:text2}}>{row.lastVisit}</span></td>
                  <td className="px-4 py-3">
...
>
  ...
  <div className="flex items-center gap-3">
    ...
    <button
      title="Delete"
      className="w-8 h-8 flex items-center justify-center rounded-lg transition-all duration-200 hover:bg-red-100 hover:scale-105"
      style={{ color: text2 }}
    >
      <svg
        width="15"
    ...
    <button
      title="View"
      className="w-8 h-8 flex items-center justify-center rounded-lg transition-all duration-200 hover:bg-blue-100 hover:scale-105"
      style={{ color: text2 }}
    >
      <svg
        width="15"
    ...
    <button
      title="Add"
      className="w-8 h-8 flex items-center justify-center rounded-lg transition-all duration-200 hover:bg-green-100 hover:scale-105"
      style={{ color: text2 }}
    >
      <svg
        width="15"
