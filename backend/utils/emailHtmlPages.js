...
function renderActionResultPage({ title, message, variant }) {
  const accent = variant === 'error' ? '#8B1A2E' : '#591727';
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8"/>
...
<body style="margin:0;padding:40px 20px;background:#F3F4F6;font-family:Georgia,'Times New Roman',serif;">
  <div style="max-width:520px;margin:0 auto;background:#fff;border-radius:16px;padding:36px 32px;border:1px solid #E5E7EB;box-shadow:0 12px 40px rgba(89,23,39,0.08);">
    <p style="margin:0 0 8px;font-size:11px;letter-spacing:0.2em;text-transform:uppercase;color:#7A3048;">Atlas Dental Center</p>
